...
import 'package:medicsbd_doctor/Screen/SetupProfile_03.dart';
...
class SetupProfile_02 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Stack(
        children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => SetupProfile_03()),
                            );
                          },
                          child: Container(
                            height: 30,
          ...
          TitleWithArrow('Hello,what\'s your name?'),
        ],
      ),
    );
  }
