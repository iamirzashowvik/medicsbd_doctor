...
import 'package:medicsbd_doctor/Screen/SetupProfile_06.dart';
...
class SetupProfile_05 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Stack(
        children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => SetupProfile_06()),
                            );
                          },
                          child: Container(
                            height: 30,
          ...
          TitleWithArrow('Type your Location'),
        ],
      ),
    );
  }
