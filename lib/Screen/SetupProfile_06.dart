...
import 'package:medicsbd_doctor/Screen/SetupProfile_07Gender.dart';
...
class SetupProfile_06 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          TitleWithArrow('Type your address'),
        ],
      ),
    );
  }
